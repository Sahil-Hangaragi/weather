...
async function currentApiCall(location){
    try{
        const res = await axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=ea1868c5540ea87299128175dad624b3&units=metric`);
        return res;
    }
    catch(error){
        if (error.response) {
...
async function callApi(location){
    try{
    const res= await axios.get(`https://api.openweathermap.org/data/2.5/forecast?q=${location}&appid=ea1868c5540ea87299128175dad624b3&units=metric`);
